...
export class FactoryDashboardComponent implements OnInit, AfterViewInit {
  ...
  reportCards = [
    { title: 'OEE', tagLine: 'Tag line goes here' },
    { title: 'Rejection', tagLine: 'Another tag line' },
    { title: 'Performance', tagLine: 'Another tag line' },
    { title: 'Downtime', tagLine: 'Another tag line' },
  ];
}
