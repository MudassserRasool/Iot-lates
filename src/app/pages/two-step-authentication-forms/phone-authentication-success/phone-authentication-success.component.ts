...
@Component({
  selector: 'app-phone-authentication-success',
  templateUrl: './phone-authentication-success.component.html',
  styleUrls: ['./phone-authentication-success.component.scss']
})
export class PhoneAuthenticationSuccessComponent implements OnInit {
